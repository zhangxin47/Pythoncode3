...
midtermfile = "C:\\Users\\b1013\\Desktop\\Pythoncode3\\Week1類別與物件\\midterm2.csv" #原始檔案位置
midterm = open(midtermfile, "r", encoding = "utf-8", newline = "") #開啟檔案
midterm_dict = csv.DictReader(midterm, delimiter = ",")
midterm_in_file = "C:\\Users\\b1013\\Desktop\\Pythoncode3\\Week1類別與物件\\midterm2_sort.csv" #寫入檔案位置
...
def printdict(d):  #主要讓程式按照Accepted , Complile Error...依序輸出，因字典是無依序的
    for i in status_list_header:
        if i == status_list_header[-1]:
            ...
            print(d[i] , end = " ")
midterm_sort_file = "C:\\Users\\b1013\\Desktop\\Pythoncode3\\Week1類別與物件\\midterm2_sort.csv"
...
printdict(dict4)
# test_time = "10:25:10"
# test_time = Time.strTotime(test_time)

# if test_time.between(start_time, end_time):
#     print("在此範圍內")
# else:
#     print("沒在範圍內")